...
import zipfile
import subprocess
import scieval.dataset.utils.Ocrbench_v2.spotting_eval.rrc_evaluation_funcs_1_1 as rrc_evaluation_funcs
from scieval.dataset.utils.Ocrbench_v2.spotting_eval.script import default_evaluation_params,validate_data,evaluate_method
...
def spotting_evaluation(prediction_list, img_metas):
    ...
    submit_path = ".scieval/dataset/utils/Ocrbench_v2/spotting_eval/submit"
    gt_path = ".scieval/dataset/utils/Ocrbench_v2/spotting_eval/gt"
    submit_zip_path = ".scieval/dataset/utils/Ocrbench_v2/spotting_eval/submit.zip"
    gt_zip_path = ".scieval/dataset/utils/Ocrbench_v2/spotting_eval/gt.zip"
