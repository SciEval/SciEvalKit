    ...
    def class_impl(self):
        lazy_imports = {
            MetricType.SIMPLE_STR_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.simple_str_match", "SimpleStrMatch"
            ),
            MetricType.EXACT_STR_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.exact_str_match", "ExactStrMatch"
            ),
            MetricType.CODE_RESULT_EXACT_STR_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.exact_str_match", "CodeResultExactStrMatch"
            ),
            MetricType.DICT_EXACT_STR_MATCH_AGG_RECALL: lazy_import(
                "scieval.dataset.utils.megabench.scoring.dict_exact_match_agg_recall",
                "DictExactStrMatchAggRecall",
            ),
            MetricType.EXACT_STR_MATCH_CASE_INSENSITIVE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.exact_str_match_case_insensitive",
                "ExactStrMatchCaseInsensitive",
            ),
            MetricType.NORM_SIM_DAMERAU_LEVENSHTEIN: lazy_import(
                "scieval.dataset.utils.megabench.scoring.normalized_similarity_damerau_levenshtein",
                "NormalizedSimilarityDamerauLevenshtein",
            ),
            MetricType.NEAR_STR_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.near_str_match", "NearStrMatch"
            ),
            MetricType.NUMBER_RELATIVE_DIFF_RATIO: lazy_import(
                "scieval.dataset.utils.megabench.scoring.number_rel_diff_ratio", "NumberRelDiffRatio"
            ),
            MetricType.SET_EQUALITY: lazy_import(
                "scieval.dataset.utils.megabench.scoring.set_equality", "SetEquality"
            ),
            MetricType.SET_EQUALITY_CASE_INSENSITIVE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.set_equality", "SetEqualityCaseInsensitive"
            ),
            MetricType.DICT_SET_EQUALITY_AGG_JACCARD: lazy_import(
                "scieval.dataset.utils.megabench.scoring.dict_set_equality_agg_jaccard",
                "DictSetEqualityAggJaccard",
            ),
            MetricType.DICT_EQUALITY: lazy_import(
                "scieval.dataset.utils.megabench.scoring.dict_equality",
                "DictEquality",
            ),
            ...
            MetricType.JACCARD_INDEX: lazy_import("scieval.dataset.utils.megabench.scoring.jaccard", "Jaccard"),
            MetricType.JACCARD_INDEX_CASE_INSENSITIVE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.jaccard", "JaccardCaseInsensitive"
            ),
            MetricType.DICT_JACCARD_AGG_JACCARD: lazy_import(
                "scieval.dataset.utils.megabench.scoring.dict_jaccard_agg_jaccard", "DictJaccardAggJaccard"
            ),
            MetricType.SET_PRECISION: lazy_import(
                "scieval.dataset.utils.megabench.scoring.set_precision", "SetPrecision"
            ),
            MetricType.POSITIVE_INT_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.positive_int_match", "PositiveIntMatch"
            ),
            MetricType.CHESS_MOVE_LIST_JACCARD_INDEX: lazy_import(
                "scieval.dataset.utils.megabench.scoring.chess_jaccard", "ChessMoveJaccard"
            ),
            MetricType.LONGEST_COMMON_LIST_PREFIX_RATIO: lazy_import(
                "scieval.dataset.utils.megabench.scoring.longest_common_list_prefix_ratio",
                "LongestCommonListPrefixRatio",
            ),
            MetricType.ASCII_ART_GPT4O_JUDGE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.ascii_art_gpt4o_judge",
                "AsciiArtVLMJudgeScore",
            ),
            MetricType.NLI_ENTAILMENT: lazy_import(
                "scieval.dataset.utils.megabench.scoring.nli_entailment", "NliEntailment"
            ),
            MetricType.BLEU: lazy_import(
                "scieval.dataset.utils.megabench.scoring.sacrebleu_bleu",
                "Bleu",
            ),
            MetricType.GLEU_CN: lazy_import(
                "scieval.dataset.utils.megabench.scoring.gleu",
                "GLEUChinese",
            ),
            MetricType.XML_NORM_BBOX_IOU_SINGLE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.xml_nbbox_iou", "XmlNbboxIouSingle"
            ),
            MetricType.BOXED_SINGLE_NUMERICAL_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.general_numerical_match", "BoxedSingleNumericalMatch"
            ),
            MetricType.GENERAL_SINGLE_NUMERICAL_MATCH: lazy_import(
                "scieval.dataset.utils.megabench.scoring.general_numerical_match", "GeneralSingleNumericalMatch"
            ),
            MetricType.SEQUENCE_COORDS_SIMILARITY: lazy_import(
                "scieval.dataset.utils.megabench.scoring.coordinate_sequence_match", "CoordsSequenceSimilarity"
            ),
            MetricType.LATEX_EXPR_EQUALITY: lazy_import(
                "scieval.dataset.utils.megabench.scoring.latex_expr_equality",
                "LatexExprEquality",
            ),
            ...
            MetricType.NORM_BBOX_IOU_TUPLE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.nbbox_iou", "NbboxIouTuple"
            ),
            MetricType.NORM_BBOX_IOU_SINGLE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.nbbox_iou", "NbboxIouSingle"
            ),
            MetricType.NORM_BBOX_IOU_SEQUENCE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.nbbox_iou", "NbboxIouSequence"
            ),
            MetricType.DICT_NORM_BBOX_IOU_TUPLE_AGG_JACCARD: lazy_import(
                "scieval.dataset.utils.megabench.scoring.dict_nbbox_iou_tuple_agg_jaccard",
                "DictNbboxIouTupleAggJaccard",
            ),
            MetricType.XML_NORM_POINT_IN_BBOX: lazy_import(
                "scieval.dataset.utils.megabench.scoring.xml_norm_point_in_bbox",
                "XmlNormPointInBbox",
            ),
            MetricType.XML_NORM_POINT_DISTANCE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.xml_norm_point_distance",
                "XmlNormPointDistance",
            ),
            MetricType.GEO_PROXIMITY_LOCATION_DICT: lazy_import(
                "scieval.dataset.utils.megabench.scoring.geo_proximity", "GeoProximityLocationDict"
            ),
            MetricType.NORMALIZED_RMSE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.mse", "NormalizedRMSE"
            ),
            MetricType.PROGRAM_JUDGE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.program_judge", "ProgramJudge"
            ),
            MetricType.STR_SET_EQUALITY_LINE_BREAK: lazy_import(
                "scieval.dataset.utils.megabench.scoring.set_equality", "StringSetEqualityLineSplit"
            ),
            MetricType.STR_SET_EQUALITY_COMMA: lazy_import(
                "scieval.dataset.utils.megabench.scoring.set_equality", "StringSetEqualityCommaSplit"
            ),
            MetricType.SEQUENCE_EQUALITY: lazy_import(
                "scieval.dataset.utils.megabench.scoring.sequence_equality", "SequenceEquality"
            ),
            MetricType.SEQUENCE_EQUALITY_CASE_INSENSITIVE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.sequence_equality", "SequenceEqualityCaseInsensitive"
            ),
            MetricType.SEQUENCE_ACCURACY_CASE_INSENSITIVE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.sequence_equality", "SequenceAccuracyCaseInsensitive"
            ),
            MetricType.ANGLE_SEQ_FLOAT_RMSE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.mse", "AngleSeqFloatRMSE"
            ),
            MetricType.SYMBOLIC_PLANNING_TEST: lazy_import(
                "scieval.dataset.utils.megabench.scoring.symbolic_planning", "SymbolicPlanningMetricTest"
            ),
            MetricType.MULTI_REF_PHRASE_EVAL: lazy_import(
                "scieval.dataset.utils.megabench.scoring.multi_ref_phrase", "MultipleReferencePhraseEval"
            ),
            MetricType.CONSTRAINED_GENERATION: lazy_import(
                "scieval.dataset.utils.megabench.scoring.constrained_generation", "ConstrainedGenerationEval"
            ),
            MetricType.VLM_AS_JUDGE: lazy_import(
                "scieval.dataset.utils.megabench.scoring.vlm_as_judge", "VLMJudgeScore"
            ),
        }
        ...
        importer = lazy_imports.get(
            self,
            lazy_import("scieval.dataset.utils.megabench.scoring.unsupported_scoring", "UnsupportedScoring"),
        )
        return importer()
