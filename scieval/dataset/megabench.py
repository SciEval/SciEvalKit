...
from scieval.dataset.video_base import VideoBaseDataset
from scieval.dataset.utils.megabench.evaluator import MEGABenchEvaluator
import json
import glob
...
class MEGABench(VideoBaseDataset):
    ...
    def evaluate(self, eval_file, **judge_kwargs):
        ...
        print("To get the breakdown results, please use the script in \
              scieval/dataset/utils/megabench/tools/derive_breakdown_results.py")
        if self.subset_name == "core":
            ...
            print(f"Put the \"core\" (to be generated) and \"open\" (at {result_path}) evaluation results \
                  in the same directory, and run the script:")
        print("cd scieval/dataset/utils/megabench/tools")
        print("python3 derive_breakdown_results.py --input_dir your/path/to/score_files")
        print("See detailed instructions in scieval/dataset/utils/megabench/README.md")
